 ...
 * 
 */
@WebServiceClient(name = "bookWeb", targetNamespace = "http://book.serviceWeb.p3.occ.org/", wsdlLocation = "http://localhost:8080/serviceWeb/ws/bookresult/bookWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKWEB_QNAME = new QName("http://book.serviceWeb.p3.occ.org/", "bookWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/serviceWeb/ws/bookresult/bookWs?wsdl");
    ...
    public BookWs getBookWsPort() {
        return super.getPort(new QName("http://book.serviceWeb.p3.occ.org/", "bookWsPort"), BookWs.class);
    }
    ...
    public BookWs getBookWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://book.serviceWeb.p3.occ.org/", "bookWsPort"), BookWs.class, features);
    }
