 ...
 * 
 */
@WebServiceClient(name = "workWeb", targetNamespace = "http://serviceWeb.p3.occ.org/", wsdlLocation = "http://localhost:8080/serviceWeb/ws/workWs?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/serviceWeb/ws/workWs?wsdl");
