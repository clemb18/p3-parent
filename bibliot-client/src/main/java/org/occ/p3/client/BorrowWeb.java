    ...
    extends Service
{
    ...
    public BorrowWs getBorrowWsPort() {
        return super.getPort(new QName("http://serviceWeb.p3.occ.org/", "borrowWsPort"), BorrowWs.class);
    }
    ...
    public BorrowWs getBorrowWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceWeb.p3.occ.org/", "borrowWsPort"), BorrowWs.class, features);
    }
