 ...
 * generated in the org.occ.p3.serviceweb.book package. 
...
public class ObjectFactory {
    ...
    private final static QName _InitResponse_QNAME = new QName("http://book.serviceWeb.p3.occ.org/", "initResponse");
    private final static QName _SaveNewBook_QNAME = new QName("http://book.serviceWeb.p3.occ.org/", "saveNewBook");
    private final static QName _GetBookByIdResponse_QNAME = new QName("http://book.serviceWeb.p3.occ.org/", "getBookByIdResponse");
    private final static QName _Init_QNAME = new QName("http://book.serviceWeb.p3.occ.org/", "init");
    private final static QName _GetBookById_QNAME = new QName("http://book.serviceWeb.p3.occ.org/", "getBookById");
    private final static QName _SaveNewBookResponse_QNAME = new QName("http://book.serviceWeb.p3.occ.org/", "saveNewBookResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.occ.p3.serviceweb.book
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://book.serviceWeb.p3.occ.org/", name = "initResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://book.serviceWeb.p3.occ.org/", name = "saveNewBook")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://book.serviceWeb.p3.occ.org/", name = "getBookByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://book.serviceWeb.p3.occ.org/", name = "init")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://book.serviceWeb.p3.occ.org/", name = "getBookById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://book.serviceWeb.p3.occ.org/", name = "saveNewBookResponse")
