 ...
 * 
 */
@WebServiceClient(name = "workWeb", targetNamespace = "http://work.serviceWeb.p3.occ.org/", wsdlLocation = "http://localhost:8080/serviceWeb/ws/workresult/workWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WORKWEB_QNAME = new QName("http://work.serviceWeb.p3.occ.org/", "workWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/serviceWeb/ws/workresult/workWs?wsdl");
    ...
    public WorkWs getWorkWsPort() {
        return super.getPort(new QName("http://work.serviceWeb.p3.occ.org/", "workWsPort"), WorkWs.class);
    }
    ...
    public WorkWs getWorkWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://work.serviceWeb.p3.occ.org/", "workWsPort"), WorkWs.class, features);
    }
